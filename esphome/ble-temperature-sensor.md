...
![Bluetooth LE temperature sensor and ESP32 microcontroller](images/img9.jpg)
...
**Hardware required**
- [Xiaomi Mijia Bluetooth thermometer (model LYWSD03MMC)](https://esphome.io/components/sensor/xiaomi_ble.html#lywsd03mmc)
...
1. In Home Assistant, navigate to **Integration** page under [**Configuration**](https://my.home-assistant.io/redirect/config/) -> [**Devices & Services**](https://my.home-assistant.io/redirect/integrations/).
